...
st.write('This app resizes images based on specified dimensions and DPI, while enhancing clarity through advanced sharpening techniques, producing high-definition and visually detailed results.')
st.write('----------------')
...
with col1:
    ...
    if uploaded_file is not None:
        st.write('----------------')
        st.subheader("Step 2: Select processing dimensions")
